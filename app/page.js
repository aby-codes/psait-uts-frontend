...
export default function Home() {
    ...
    const deleteData = async (nim, kode_mk) => {
        try {
            await axios.delete(
                `http://127.0.0.1:8000/api/delete/${nim}/${kode_mk}`
            );
    ...
    return (
        <main className="flex flex-col min-h-screen bg-gray-100">
            <div className="container mx-auto px-4 py-6 bg-white shadow">
                <h1 className="text-3xl font-semibold text-gray-800">UTS PSAIT B2 - Abyan</h1>
            </div>
        ...
        Add Grades
                    ...
                    <div className="bg-white p-6 rounded-md shadow-md overflow-x-auto">
                        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Table</h2>
